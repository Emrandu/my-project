    ...
    return (
       <div className='bg-gray-100 px-4 py-5 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8'>
         ...
         <div className='relative flex items-center justify-between'>
            ...
            <BoltIcon className='h-5 w-6 text-blue-600' />
            ...
            <ul className='items-center hidden space-x-8 lg:flex mr-8'>
                ...
                <li>
                    <NavLink to='/books'
                     title='Book Link'
                    className={({isActive}) => ( isActive ? 'active' : 'default' )}>Books</NavLink>
                </li>
                <li>
                    <NavLink to='/about'
                    title='About Link'
                    className={({isActive}) => ( isActive ? 'active' : 'default' )}>About Us</NavLink>
                </li>
            </ul>
                              ...
                              <div className='flex items-center justify-between mb-4'>
                                ...
                                <nav>
                                    <ul className='space-y-4'>
                                        ...
                                        <li>
                                            <Link to='/about' className='font-medium tracking-wide text-gray-700 transition-color duration-200 hover:text-green-800'>
                                                About Us
                                            </Link>
                                        </li>
